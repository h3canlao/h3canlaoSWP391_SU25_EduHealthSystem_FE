...
const routes = [
  ...
  {
    key: "medication",
    icon: <AppstoreOutlined />, label: "Quản lý thuốc",
    children: [
      { key: "/admin/manage-medication", icon: <MedicineBoxOutlined />, label: "Danh sách thuốc" },
    ]
  },
  {
    key: "medical-supply",
    icon: <MedicineBoxOutlined />, label: "Vật tư y tế",
    children: [
      { key: "/admin/manage-medicalSupply", icon: <FormOutlined />, label: "Danh sách vật tư" },
    ]
  },
  {
    key: "vaccination",
    icon: <FileProtectOutlined />, label: "Tiêm chủng",
    children: [
